...
- [ ] Effective config built from `~/.nakiros.yaml` + project `.nakiros.yaml`.
...
- [ ] Story artifact persisted to `.nakiros/workflows/stories/{{ticketId}}.json`.
...
- [ ] Internal JSON artifacts (.nakiros/ files) in ENGLISH (agent performance).
