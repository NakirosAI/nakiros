...
import { ArrowLeft, ChevronRight, ChevronDown, File, Loader2, Play, Plus, Save, Search, Sparkles, CheckCircle, Wrench, XCircle, FlaskConical } from 'lucide-react';
import clsx from 'clsx';
import type { AuditRun, Project, Skill, SkillEvalGrading, SkillEvalGradingRun, SkillScope } from '@nakiros/shared';
