...
- [project-bootstrap.ts](./project-bootstrap.md) — Types for the project `.claude` Bootstrap feature: the global configuration plan and the interactive plan → discuss → approve → execute runner.
