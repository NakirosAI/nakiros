...
2. READ its entire contents - this is the CORE OS for EXECUTING the specific workflow-config @~/.nakiros/workflows/1-discovery/project-understanding-confidence/workflow.yaml
3. Pass the yaml path ~/.nakiros/workflows/1-discovery/project-understanding-confidence/workflow.yaml as 'workflow-config' parameter to the workflow.xml instructions
