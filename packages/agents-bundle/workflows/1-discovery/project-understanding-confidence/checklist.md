...
- [ ] Confidence artifact path points to workspace runtime root (`{workspace_root_dir}/...`).
...
- [ ] Markdown report written to `{workspace_confidence_dir}/project-understanding-confidence-{date}.md`.
- [ ] JSON report written to `{workspace_confidence_dir}/project-understanding-confidence-{date}.json`.
- [ ] Workflow snapshot written to `{steps_dir}/project-understanding-confidence-{date}.md`.
