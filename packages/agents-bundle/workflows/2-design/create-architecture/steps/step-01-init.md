...
- **STOP here** and load `{installed_path}/steps/step-01b-continue.md` immediately
...
After user selects [C] to continue, only after ensuring all the template output has been created, then load `{installed_path}/steps/step-02-context.md` to analyze the project context and begin architectural decision making.
