...
- Example: If `stepsCompleted: [1, 2, 3]`, load `{installed_path}/steps/step-04-decisions.md`
...
- If confirmed: Delete existing document and read fully and follow: `{installed_path}/steps/step-01-init.md`
...
- `{installed_path}/steps/step-02-context.md`
- `{installed_path}/steps/step-03-starter.md`
- `{installed_path}/steps/step-04-decisions.md`
- `{installed_path}/steps/step-05-patterns.md`
- `{installed_path}/steps/step-06-structure.md`
- `{installed_path}/steps/step-07-validation.md`
- `{installed_path}/steps/step-08-complete.md`
