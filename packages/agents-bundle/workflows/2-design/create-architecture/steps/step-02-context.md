...
- Read fully and follow: ~/.nakiros/core/workflows/advanced-elicitation/workflow.xml with the current context analysis
...
- Read fully and follow: ~/.nakiros/core/workflows/party-mode/workflow.md with the current project context
...
- Load `{installed_path}/steps/step-03-starter.md`
...
After user selects 'C' and content is saved to document, load `{installed_path}/steps/step-03-starter.md` to evaluate starter template options.
