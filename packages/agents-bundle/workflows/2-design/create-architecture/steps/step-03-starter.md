...
- Read fully and follow: ~/.nakiros/core/workflows/advanced-elicitation/workflow.xml with current starter analysis
...
- Read fully and follow: ~/.nakiros/core/workflows/party-mode/workflow.md with starter evaluation context
...
- Load `{installed_path}/steps/step-04-decisions.md`
...
After user selects 'C' and content is saved to document, load `{installed_path}/steps/step-04-decisions.md` to begin making specific architectural decisions.
