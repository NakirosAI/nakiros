...
- Read fully and follow: ~/.nakiros/core/workflows/advanced-elicitation/workflow.xml with current patterns
...
- Read fully and follow: ~/.nakiros/core/workflows/party-mode/workflow.md with implementation patterns context
...
- Load `{installed_path}/steps/step-06-structure.md`
...
After user selects 'C' and content is saved to document, load `{installed_path}/steps/step-06-structure.md` to define the complete project structure.
