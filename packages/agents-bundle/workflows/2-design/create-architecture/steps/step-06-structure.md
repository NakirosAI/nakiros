...
- Read fully and follow: ~/.nakiros/core/workflows/advanced-elicitation/workflow.xml with current project structure
...
- Read fully and follow: ~/.nakiros/core/workflows/party-mode/workflow.md with project structure context
...
- Load `{installed_path}/steps/step-07-validation.md`
...
After user selects 'C' and content is saved to document, load `{installed_path}/steps/step-07-validation.md` to validate architectural coherence and completeness.
