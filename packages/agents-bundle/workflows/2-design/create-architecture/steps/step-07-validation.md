...
- Read fully and follow: ~/.nakiros/core/workflows/advanced-elicitation/workflow.xml with validation issues
...
- Read fully and follow: ~/.nakiros/core/workflows/party-mode/workflow.md with validation context
...
- Load `{installed_path}/steps/step-08-complete.md`
...
After user selects 'C' and content is saved to document, load `{installed_path}/steps/step-08-complete.md` to complete the workflow and provide implementation guidance.
