...
Architecture complete. Stop the workflow here, confirm the final architecture artifact path to the user, and offer the next relevant Nakiros workflow or agent command.
