...
After user selects [C] to continue, ensure the file `{planning_artifacts}/ux-design-specification.md` has been created and saved, and then load `{installed_path}/steps/step-02-discovery.md` to begin the UX discovery phase.
