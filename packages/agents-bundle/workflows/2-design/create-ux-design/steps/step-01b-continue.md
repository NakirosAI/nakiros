...
- If `lastStep = 1` → Load `{installed_path}/steps/step-02-discovery.md`
- If `lastStep = 2` → Load `{installed_path}/steps/step-03-core-experience.md`
- If `lastStep = 3` → Load `{installed_path}/steps/step-04-emotional-response.md`
