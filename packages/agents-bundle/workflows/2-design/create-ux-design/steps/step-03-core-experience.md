...
- Read fully and follow: ~/.nakiros/core/workflows/advanced-elicitation/workflow.xml with the current core experience content
...
- Read fully and follow: ~/.nakiros/core/workflows/party-mode/workflow.md with the current core experience definition
...
- Load `{installed_path}/steps/step-04-emotional-response.md`
...
After user selects 'C' and content is saved to document, load `{installed_path}/steps/step-04-emotional-response.md` to define desired emotional responses.
