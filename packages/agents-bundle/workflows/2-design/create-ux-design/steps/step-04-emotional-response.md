...
- Read fully and follow: ~/.nakiros/core/workflows/advanced-elicitation/workflow.xml with the current emotional response content
...
- Read fully and follow: ~/.nakiros/core/workflows/party-mode/workflow.md with the current emotional response definition
...
- Load `{installed_path}/steps/step-05-inspiration.md`
...
After user selects 'C' and content is saved to document, load `{installed_path}/steps/step-05-inspiration.md` to analyze UX patterns from inspiring products.
