...
- Read fully and follow: ~/.nakiros/core/workflows/advanced-elicitation/workflow.xml with the current design system content
...
- Read fully and follow: ~/.nakiros/core/workflows/party-mode/workflow.md with the current design system choice
...
- Load `{installed_path}/steps/step-07-defining-experience.md`
...
After user selects 'C' and content is saved to document, load `{installed_path}/steps/step-07-defining-experience.md` to define the core user interaction.
