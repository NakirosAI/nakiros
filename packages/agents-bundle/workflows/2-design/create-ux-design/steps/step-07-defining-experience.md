...
- Read fully and follow: ~/.nakiros/core/workflows/advanced-elicitation/workflow.xml with the current defining experience content
...
- Read fully and follow: ~/.nakiros/core/workflows/party-mode/workflow.md with the current defining experience
...
- Load `{installed_path}/steps/step-08-visual-foundation.md`
...
After user selects 'C' and content is saved to document, load `{installed_path}/steps/step-08-visual-foundation.md` to establish visual design foundation.
