...
- Read fully and follow: ~/.nakiros/core/workflows/advanced-elicitation/workflow.xml with the current visual foundation content
...
- Read fully and follow: ~/.nakiros/core/workflows/party-mode/workflow.md with the current visual foundation
...
- Load `{installed_path}/steps/step-09-design-directions.md`
...
After user selects 'C' and content is saved to document, load `{installed_path}/steps/step-09-design-directions.md` to generate design direction mockups.
