...
- Read fully and follow: ~/.nakiros/core/workflows/advanced-elicitation/workflow.xml with the current design direction content
...
- Read fully and follow: ~/.nakiros/core/workflows/party-mode/workflow.md with the current design direction
...
- Load `{installed_path}/steps/step-10-user-journeys.md`
...
After user selects 'C' and content is saved to document, load `{installed_path}/steps/step-10-user-journeys.md` to design user journey flows.
