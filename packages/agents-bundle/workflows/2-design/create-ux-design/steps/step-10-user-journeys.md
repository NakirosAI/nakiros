...
- Read fully and follow: ~/.nakiros/core/workflows/advanced-elicitation/workflow.xml with the current user journey content
...
- Read fully and follow: ~/.nakiros/core/workflows/party-mode/workflow.md with the current user journeys
...
- Load `{installed_path}/steps/step-11-component-strategy.md`
...
After user selects 'C' and content is saved to document, load `{installed_path}/steps/step-11-component-strategy.md` to define component library strategy.
