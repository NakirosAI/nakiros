...
- Read fully and follow: ~/.nakiros/core/workflows/advanced-elicitation/workflow.xml with the current component strategy content
...
- Read fully and follow: ~/.nakiros/core/workflows/party-mode/workflow.md with the current component strategy
...
- Load `{installed_path}/steps/step-12-ux-patterns.md`
...
After user selects 'C' and content is saved to document, load `{installed_path}/steps/step-12-ux-patterns.md` to define UX consistency patterns.
