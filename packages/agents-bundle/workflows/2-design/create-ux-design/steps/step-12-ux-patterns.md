...
- Read fully and follow: ~/.nakiros/core/workflows/advanced-elicitation/workflow.xml with the current UX patterns content
...
- Read fully and follow: ~/.nakiros/core/workflows/party-mode/workflow.md with the current UX patterns
...
- Load `{installed_path}/steps/step-13-responsive-accessibility.md`
...
After user selects 'C' and content is saved to document, load `{installed_path}/steps/step-13-responsive-accessibility.md` to define responsive design and accessibility strategy.
