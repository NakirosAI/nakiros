...
- Read fully and follow: ~/.nakiros/core/workflows/advanced-elicitation/workflow.xml with the current responsive/accessibility content
...
- Read fully and follow: ~/.nakiros/core/workflows/party-mode/workflow.md with the current responsive/accessibility strategy
...
- Load `{installed_path}/steps/step-14-complete.md`
...
After user selects 'C' and content is saved to document, load `{installed_path}/steps/step-14-complete.md` to finalize the UX design workflow.
